...
<html>
    ...
    <body>
            ...
            <div class="logo-section px-lg-5 pt-lg-1 p-0">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="logo">
                                <a class="d-lg-none d-block" href="{{'/'}}"><img src="front/image/mobile-logo.svg" alt="catframes-mobile"></a>
                            </div>
                        </div>
                         <div class="col-6 d-lg-none d-block">
                            <div class="logo d-flex justify-content-end">
                                <a data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation" href="#"><img src="front/image/burger.svg" alt="catframes"></a>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="container-fluid flex-lg-row flex-row-reverse px-lg-0">
    ...
    <a class="navbar-brand d-block" href="#">
      <a class="d-lg-block d-none" href="{{'/'}}"><img src="front/image/catframes.svg" alt="catframes"></a>
    </a>
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
        ...
        <li class="nav-item dropdown1">
          <a class="nav-link1 dropdown-toggle1 text-uppercase" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Services<img class="ms-2" src="front/image/angle-down.svg">
