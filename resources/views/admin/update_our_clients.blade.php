                    ...
                    <div class="basic-form">
                        ...
                        @method('PUT')
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="hidden" name="old_image" value="{{$add_client->image}}" >
                              </div>
                                @if ($errors->has('image'))
                                <span class="text-danger">{{ $errors->first('image') }}</span>
                                @endif
                              <div class="basic-form">
                                <select name="status" class="default-select size-1 form-control wide mb-3 text-center">
